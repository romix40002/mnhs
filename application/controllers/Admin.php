...
class Admin extends CI_Controller
{
	...
	function acd_session($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
			...
			$data['strt_dt'] = $this->input->post('strt_dt');
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $data['endsemRes']	= $this->input->post('endsem');
            $data['startsemRes']	= $this->input->post('startsem');
            // $data['year']		= $this->input->post('year');
            $data['schoolYear']		= $this->input->post('syear');
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/announcement/' . $teacher_id . '.jpg');
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
        ...
        if ($param1 == 'do_update') {
            ...
            $this->db->where('teacher_id', $param2);
            $this->db->update('teacher', $data);
            move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/announcement/' . $param2 . '.jpg');
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?admin/teacher/', 'refresh');
        } else if ($param1 == 'personal_profile') {
            $page_data['personal_profile']   = true;
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $data['date_created'] = $this->input->post('dateAdded');

            $this->db->insert('noticeboard', $data);
            $notice_id = $this->db->insert_id();
            move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/announcement/' . $notice_id . '.jpg');
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
