<div class="row">
	<div class="col-md-12 col-sm-12 clearfix" style="text-align:center;">
		<h2 style="font-weight:700; color: #2ed573; margin:0px; font-family: cursive;"><marquee>Muntinlupa National High School Student Information System</marquee><br></h2>
    </div>
	<!-- Raw Links -->
	<div class="col-md-12 col-sm-12 clearfix ">
        ...
        <!-- Language Selector --><br>		
           <li class="dropdown language-selector">
                    <h4 class="dropdown-toggle" data-toggle="dropdown" data-close-others="true"><a href="#" >
