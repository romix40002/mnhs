...
<div class="login-container">
	...
	<div class="login-header login-caret">
			<p class="description">
            	<a href="home.php" style="color:white; font-weight:800; font-family: cursive; margin-left: 588px; color: #fff200; cursor: pointer;">
					<h1>Home 
						<a href="about.php" style="color:white; font-weight:800; font-family: cursive; margin-left: 170px; color: #fff200; cursor: pointer;">About
						</a>
					</h1><hr style="width: 400px;">
              </a>
