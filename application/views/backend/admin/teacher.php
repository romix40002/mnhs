            ...
            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_teacher_add/');" 
                ...
                <br><br>
                <!-- SET AND TABLE ID TO table_export ARUN NAAY PRINT BTN -->
                
               <table class="table table-bordered table-hover table-striped datatable" id="">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img src="uploads/announcement/<?php echo $row['teacher_id'];?>.jpg" class="img-circle" width="30" /></td>
