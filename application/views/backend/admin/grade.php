            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered table-hover table-striped datatable" id="table_export">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo 'Grade Title'?></div></th>
                    		<!-- <th><div><?php echo ('Grade Point');?></div></th> -->
                    		<th><div><?php echo 'From'?></div></th>
                    		<th><div><?php echo 'Up to'?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td style="background-color: #12CBC4; color: white; border-radius: 15px; font-size: 20px; font-family: cursive;"><?php echo $row['name'];?></td>
							<!-- <td><?php echo $row['grade_point'];?></td> -->
							<td><?php echo $row['mark_from'];?></td>
							<td><?php echo $row['mark_upto'];?></td>
							<td style="font-size: 15px; font-family: cursive;"><?php echo $row['comment'];?></td>
							<td>
                            <div class="btn-group">
                	...
                	<?php echo form_open(base_url() . 'index.php?admin/grade/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5 controls">
                                    <input type="text" class="form-control" name="name" placeholder="e.g  A+, A, B, C" required>
                                </div>
                            </div>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-5 controls">
                                    <input type="text" class="form-control" name="grade_point" placeholder="">
                                </div>
                            </div> -->

                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo 'From'?></label>
                                <div class="col-sm-5 controls">
                                    <input type="text" class="form-control" name="mark_from" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo 'Up to';?></label>
                                <div class="col-sm-5 controls">
