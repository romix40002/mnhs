<div class="sidebar-menu">
    <header class="logo-env" >
        ...
        <!-- <div class="sidebar-collapse" style="">
            <a href="<?php echo base_url(); ?>" class="sidebar-collapse-icon with-animation">
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'acd_session') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/acd_session">
                <span><i class="entypo-book"></i>School Year</span>
            </a>
        </li>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo 'Grades & Examination'; ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'exam') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/exam">
                        <span><i class="entypo-dot"></i> <?php echo 'Examination' ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'grade') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/grade">
                        <span><i class="entypo-dot"></i> <?php echo 'Grading Criteria' ?></span>
                    </a>
                </li>
        ...
        <li class="<?php if ($page_name == 'noticeboard') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/noticeboard">
                ...
                <span><?php echo 'Event & Announcement' ?></span>
            </a>
        </li>
