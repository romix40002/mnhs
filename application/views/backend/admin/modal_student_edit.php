...
<div class="row">
	...
	<!-- REMOVE MO YUNG COMMNET IF GUSTO MO MAGKAROON NG UPLOAD PROFILE PIC YUNG STUDENT -->
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label">Database ID</label>
					...
					?>
                         <input type="hidden" name="class_id" id="class_id" value="<?php echo $row2['class_id'];?>">
                    <?php
						endforeach;
					?>
