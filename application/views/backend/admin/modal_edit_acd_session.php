			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/acd_session/do_update/'.$row['id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="strt_dt" value="<?php echo $row['strt_dt'];?>" required>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="end_dt" value="<?php echo $row['end_dt'];?>" required>
                        </div>
                    </div>
                    <div class="form-group">
